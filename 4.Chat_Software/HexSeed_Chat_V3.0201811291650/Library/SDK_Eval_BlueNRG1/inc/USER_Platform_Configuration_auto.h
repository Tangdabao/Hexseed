...
#define PUSH_OFF_PWR_BUTTON_PIN                    s_vectnButtonPinVersion[SdkEvalGetVersion()-1][0]
#define PUSH_ON_PWR_BUTTON_PIN                     s_vectnButtonPinVersion[SdkEvalGetVersion()-1][1]
 ...
 */
extern const uint32_t s_vectnGpioPinVersion[][8];

#define SDK_EVAL_EN_PWR_PIN                   s_vectnGpioPinVersion[SdkEvalGetVersion()-1][0]
#define SDK_EVAL_LED2_G_PIN                   s_vectnGpioPinVersion[SdkEvalGetVersion()-1][1]   
#define SDK_EVAL_LED_W_PIN                    s_vectnGpioPinVersion[SdkEvalGetVersion()-1][2] 
#define SDK_EVAL_LED2_R_PIN                   s_vectnGpioPinVersion[SdkEvalGetVersion()-1][3] 
#define SDK_EVAL_OG_PIN                       s_vectnGpioPinVersion[SdkEvalGetVersion()-1][4]
#define SDK_EVAL_LED1_G_PIN                   s_vectnGpioPinVersion[SdkEvalGetVersion()-1][5]   
#define SDK_EVAL_LED1_R_PIN                   s_vectnGpioPinVersion[SdkEvalGetVersion()-1][6] 
#define SDK_EVAL_VCC_PWR_PIN                  s_vectnGpioPinVersion[SdkEvalGetVersion()-1][7] 
