...
uint32_t Get_LedGpioPin(SdkEvalLed xLed)
{
    ...
    {
    case(EN_PWR):
        led_pin = SDK_EVAL_EN_PWR_PIN;
        break;
    case(LED2_G):
        led_pin = SDK_EVAL_LED2_G_PIN;
        break;
    case(LED_W):
        led_pin = SDK_EVAL_LED_W_PIN;
        break;
    case(LED2_R):
        led_pin = SDK_EVAL_LED2_R_PIN;
        break;

    case(OG):
        led_pin = SDK_EVAL_OG_PIN;
        break;
    case(LED1_G):
        led_pin = SDK_EVAL_LED1_G_PIN;
        break;
    case(LED1_R):
        led_pin = SDK_EVAL_LED1_R_PIN;
        break;
    case(VCC_PWR):
        led_pin = SDK_EVAL_VCC_PWR_PIN;
        break;
...
void SdkEvalLedFlicker(SdkEvalLed xLed)
{
