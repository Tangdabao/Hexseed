 ...
 */
const uint32_t s_vectnButtonPinVersion[SDK_PLATFORMS_NUMBER][EVAL_BOARD_BUTTONS] = {{GPIO_Pin_13, GPIO_Pin_1}};
 ...
 */
//const uint32_t s_vectnGpioPinVersion[SDK_PLATFORMS_NUMBER][EVAL_BOARD_LEDS] = {{GPIO_Pin_5, GPIO_Pin_5, GPIO_Pin_3,GPIO_Pin_1}};
const uint32_t s_vectnGpioPinVersion[SDK_PLATFORMS_NUMBER][EVAL_BOARD_LEDS] = {{GPIO_Pin_1, GPIO_Pin_2, GPIO_Pin_3, GPIO_Pin_4, GPIO_Pin_5, GPIO_Pin_8, GPIO_Pin_11, GPIO_Pin_14}};
