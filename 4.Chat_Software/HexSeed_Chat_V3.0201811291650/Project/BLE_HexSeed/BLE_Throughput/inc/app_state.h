...
#define TX_BUFFER_FULL          0x20//BLE to Phone
#define RX_BUFFER_FULL          0x40//phone to BLE

//*MODIFY 20181113 ADD BATTERY SERVICE*//
#define NOTIFICATIONS_BAT_ENABLED   0x80	
