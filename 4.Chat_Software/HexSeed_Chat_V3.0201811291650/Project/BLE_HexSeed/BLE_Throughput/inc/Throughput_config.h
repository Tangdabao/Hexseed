...
#define NUM_APP_GATT_SERVICES    1 + 1  /* 1 throughput service */

/* Number of attributes requests from the throughput demo */
#define NUM_APP_GATT_ATTRIBUTES   5 + 8 /* 5 attributes x BLE throughput service characteristics */
...
#elif SERVER
#define ATT_VALUE_ARRAY_SIZE    (44 + 80 + 80+ 41) //(GATT + GAP) = 44 + Chat  (TX (41) + RX (39) characteristics)   Services
#endif 
