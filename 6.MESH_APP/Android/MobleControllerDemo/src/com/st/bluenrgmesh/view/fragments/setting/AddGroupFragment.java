...
/**
 * Created by sharma01 on 10/30/2018.
 */
...
public class AddGroupFragment extends BaseFragment {
    ...
    public static void checkGrpHasSubElements(final Context context, ArrayList<Element> eleSubscriptionList, final mobleAddress addr) {
