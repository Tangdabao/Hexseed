...
#define PWM2_PIN                        GPIO_Pin_3 //YELLOW LED  
#define PWM3_PIN                        GPIO_Pin_3 
#define PWM4_PIN                        GPIO_Pin_3//GPIO_Pin_1


#define TIME_PERIOD 4000

/* MFT1 Timer 1 Ton and T0ff (ticks number) PWM0*/
#define MFT1_TON_1  (2000 - 1)
#define MFT1_TOFF_1 (2000 - 1)
/* MFT1 Timer 2 Ton and T0ff (ticks number) PWM2*/
#define MFT1_TON_2 (50 - 1)
#define MFT1_TOFF_2 (3950 -1)

/* MFT2 Timer 1 Ton and T0ff (ticks number) PWM1*/
#define MFT2_TON_1 (2 - 1 )
#define MFT2_TOFF_1 (3999 - 1)
